...
NS_LOG_COMPONENT_DEFINE("Pattern1");
...
int main(int argc, char *argv[])
{
  ...
  csma.EnablePcap("Pattern1 n1 to n5", deviceTor3.Get(1), true);
  ...
  csma.EnablePcap("Pattern1 n6 to n2", deviceTor1.Get(2), true);
  ...
  csma.EnablePcap("Pattern1 n3 to n7", deviceTor4.Get(1), true);
  ...
  csma.EnablePcap("Pattern1 n8 to n4", deviceTor2.Get(2), true);
  
  // record the ptp trace
  corePTP1.EnablePcapAll("Pattern1 corePTP1");
  corePTP2.EnablePcapAll("Pattern1 corePTP2");
