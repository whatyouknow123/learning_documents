...
int main(int argc, char *argv[])
{
  ...
  // create the added aggragation nodes
  // TODO
  NodeContainer aggNode3;
  aggNode3.Add(coreNode3.Get(1));
  aggNode3.Add(aggNode1.Get(1));
  aggNode3.Add(aggNode1.Get(2));
  
  NodeContainer aggNode4;
  aggNode4.Add(coreNode4.Get(1));
  aggNode4.Add(aggNode2.Get(1));
  aggNode4.Add(aggNode2.Get(2));
  ...
  // create the added aggragation tohopoly
  // TODO
  NetDeviceContainer deviceAgg3, deviceAgg4;
  deviceAgg3 = csma.Install(aggNode3);
  deviceAgg4 = csma.Install(aggNode4);
  ...
  stack.Install(aggNode3.Get(0));
  stack.Install(aggNode4.Get(0));
  ...
  // set the address for the addad aggregation
  // TODO
  address.SetBase("10.3.1.0", "255.255.255.0"); 
  Ipv4InterfaceContainer aggCsmaInterfaces3;
  aggCsmaInterfaces3 = address.Assign(deviceAgg3);

  address.SetBase("10.4.1.0", "255.255.255.0");
  Ipv4InterfaceContainer aggCsmaInterfaces4;
  aggCsmaInterfaces4 = address.Assign(deviceAgg4);
